          ...
          <div className="row">
            <div className="col-md-12">
              <div className="form-group">
                ...
                <textarea id="form_message" name="message" className="form-control" placeholder="Message for me *" rows={4} required="required" data-error="Please, leave us a message." defaultValue={""} value={this.state.message} onChange={this.onChange} />
                <div className="help-block with-errors" />
              </div>
            </div>
            <div className="col-md-12">
